...
namespace UnlimitedScrollUI {
    public class GridUnlimitedScroller : GridLayoutGroup, IUnlimitedScroller {
        ...
        private Func<int, GameObject> _prefabFetcher;

        #endregion


        public void SetFetcher(Func<int, GameObject> fetchPrefabById)
        {
            _prefabFetcher = fetchPrefabById;
        }
